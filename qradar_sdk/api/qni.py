...
class HostsConfigsResource(ResourceBase):
    """Operations below ``/qni/hosts/{host_id}/configs``."""

    def list(self, host_id, fields: Optional[Any]=None, filter: Optional[Any]=None, range_header: Optional[Any]=None, **kwargs: Any) -> Any:
    ...
    def update(self, host_id, id, body: Optional[Any]=None, fields: Optional[Any]=None, **kwargs: Any) -> Any:
...
class StackingStacksResource(ResourceBase):
    """Operations below ``/qni/stacking/stacks``."""
    ...
    def update(self, stack_id, body: Optional[Any]=None, fields: Optional[Any]=None, **kwargs: Any) -> Any:
...
class StackingStandaloneHostsResource(ResourceBase):
    """Operations below ``/qni/stacking/standalone_hosts``."""
...
class HostsResource(ResourceBase):
    """Operations below ``/hosts``."""

    def __init__(self, session: QRadarSession) -> None:
        super().__init__(session)
        self.configs: HostsConfigsResource = HostsConfigsResource(session)


class StackingResource(ResourceBase):
    """Operations below ``/stacking``."""

    def __init__(self, session: QRadarSession) -> None:
        super().__init__(session)
        self.stacks: StackingStacksResource = StackingStacksResource(session)
        self.standalone_hosts: StackingStandaloneHostsResource = StackingStandaloneHostsResource(session)


class QniAPI(ResourceBase):
    """Resource-oriented client for the ``qni`` endpoints."""

    def __init__(self, session: QRadarSession) -> None:
        super().__init__(session)
        self.hosts: HostsResource = HostsResource(session)
        self.stacking: StackingResource = StackingResource(session)
